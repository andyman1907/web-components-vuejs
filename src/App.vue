...
#app
  ...
  //- hr
  //- Sidenav(
  //-   structure='{"structure":{"buttonText":"abrir menú lateral","content":[{"id":1,"title":"titulo de prueba 1","href":"link de prueba 1"},{"id":2,"title":"titulo de prueba 2","href":"link de prueba 2"}]}}'
  //- )
  //- hr
